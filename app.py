...
1. ONE-PAGE MAXIMUM: Ensure the resume fits on a single page using concise, powerful language.
...
2. JOB-SPECIFIC ALIGNMENT:
   ...
   - Adjust section ordering if necessary to emphasize most relevant qualifications first
...
4. SPACE OPTIMIZATION:
   - Utilize line space efficiently (no lines with just one or two words)
...
5. COURSEWORK RELEVANCE:
   - Adjust coursework listings to showcase academic background relevant to the position
   - Replace less relevant courses with more applicable ones based on job description
...
Output: Return ONLY the complete, optimized LaTeX code without any explanations, comments, markdown, or code block markers.
"""
